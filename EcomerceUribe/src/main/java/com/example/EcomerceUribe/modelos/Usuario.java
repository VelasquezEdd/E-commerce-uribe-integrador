...
public class Usuario {
    ...
    public Usuario(Integer id, String nombres, String correo, String contarseña, EstadosUsuario estado, LocalDate fechaNacimiento, TipoDocumento tipoDocumento, String documento) {
        this.id = id;
